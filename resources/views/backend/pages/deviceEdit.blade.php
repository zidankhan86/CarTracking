...
<div class="col-12">
    <form action="{{ route('device.update',$edit->id) }}" method="post" enctype="multipart/form-data">
        @csrf
      <div class="card-body">
        <h3 class="card-title">Device Edit</h3>
        <div class="row row-cards">
          ...
          <div class="col-sm-6 col-md-6">
            <div class="mb-3">
              ...
              <input type="text" name="monthly_charge" value="{{ $edit->monthly_charge }}" class="form-control" placeholder="200">
            </div>
          </div>
          <div class="col-sm-6 col-md-6">
            <div class="mb-3">
